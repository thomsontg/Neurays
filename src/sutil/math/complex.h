...
SUTILFN float abs(m_complex c)
{
	return sqrtf(c.re * c.re + c.im * c.im);
}

SUTILFN float abs_sqr(m_complex c)
{
	return c.re * c.re + c.im * c.im;
}

SUTILFN m_complex conj(m_complex c)
{
	m_complex result = {c.re, -c.im};
	return result;
}

SUTILFN m_complex operator+(m_complex c1, m_complex c2)
{
	m_complex result = {c1.re + c2.re, c1.im + c2.im};
	return result;
}

SUTILFN m_complex operator+(m_complex c1, float c2)
{
	m_complex result = {c1.re + c2, c1.im};
	return result;
}

SUTILFN m_complex operator+(float c1, m_complex c2)
{
	m_complex result = {c1 + c2.re, c2.im};
	return result;
}

SUTILFN m_complex operator-(m_complex c)
{
	m_complex result = {-c.re, -c.im};
	return result;
}
...
SUTILFN float phase(m_complex c)
{
	return atan2(c.im, c.re);
}

SUTILFN m_complex pow(m_complex c, int n)
{
...
SUTILFN m_complex pow(m_complex c, float n)
{
	float rn = static_cast<float>(pow(abs(c), n));
...
SUTILFN m_complex sqrt(m_complex c)
{
	float r = abs(c);
...
SUTILFN m_complex exp(m_complex c)
{
...
SUTILFN complex3 conj(complex3 c)
{
...
SUTILFN complex3 operator+(complex3 c1, complex3 c2)
{
	complex3 result = {c1.x + c2.x, c1.y + c2.y, c1.z + c2.z};
	return result;
}

SUTILFN complex3 operator+(complex3 c1, float c2)
{
	complex3 result = {c1.x + c2, c1.y + c2, c1.z + c2};
	return result;
}

SUTILFN complex3 operator+(float c1, complex3 c2)
{
	complex3 result = {c1 + c2.x, c1 + c2.y, c1 + c2.z};
	return result;
}

SUTILFN complex3 operator-(complex3 c)
{
...
SUTILFN float3 phase(complex3 c)
{
	float3 result;
	result.x = phase(c.x);
	result.y = phase(c.y);
...
SUTILFN complex3 pow(complex3 c, int exp)
{
	complex3 result = {pow(c.x, exp), pow(c.y, exp), pow(c.z, exp)};
	return result;
}

SUTILFN complex3 sqrt(complex3 c)
{
