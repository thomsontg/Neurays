...
namespace
{
  ...
  // Data from Walstra and Jenness [1984] (real part) and Michalski et al. [2001] (imaginary part)
...
Medium milk(LogNormalParticleDistrib& fat,    // Distribution of fat globules
            ...
            double protein_weight)            // protein weight-%
{
  // Data from Walstra and Jenness [1984]
  ...
  casein.refrac_idx =  complex<double>(1.503, 0.0); // [Attaie and Richtert 2000]
